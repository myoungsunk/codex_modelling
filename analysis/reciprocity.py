...
def reciprocity_sanity(
    ...
    rev_map: dict[tuple[int, str, tuple[tuple[float, float, float], ...]], list[PathResult]] = {}
    for p in rev:
        rev_map.setdefault(_path_key(p, reverse_order=True), []).append(p)

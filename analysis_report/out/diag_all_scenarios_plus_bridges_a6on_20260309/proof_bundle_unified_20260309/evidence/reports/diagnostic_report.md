# Diagnostic Report (diag_all_scenarios_plus_bridges_a6on_20260309)
...
| --- | --- | --- | --- | --- | --- |
| 25.06 | 0.4494 | 24.68 | 25.58 | 9 | p5_p95 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| link_rows.xpd_floor_freq_hz[C0] | 2.5e-10 | 3.175e-08 | 3e-09 | 3e-08 | -237.2 | PASS | 1 | 0.1667 | -230.4 | -227.8 | 1 | PASS | 0.6667 | WARN | WARN | FAIL | FAIL | PASS | 1 | 1 | A6_near_normal_benchmark | PASS | PASS | FAIL | contamination_response | response | True | 1.033e-09 | PASS | PASS | 2 | 0.7365 | WARN |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1.5e-09 | -237.2 | -232.8 | 1 | 1 | PASS | 9 |
...
| A4 | 1 | 1 | 1 | 1 | -220.7 | 1.136e-08 | PASS |
| A5 | 2 | 1 | 0.06667 | 0.2 | 0 | 0 | FAIL |

- W_early(room/grid) Te sweep separation

| Te_ns | S_xpd_early | S_rho_early_db | S_l_pol |
| --- | --- | --- | --- |
| 2 | 0.7365 | 0.7365 | 0.6411 |
| 3 | 0.7256 | 0.7256 | 0.6336 |
| 5 | 0.627 | 0.627 | 0.4419 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A2 | 1 | 3e-09 | negative | 4 | excess | 1 | 1 | 1 | -8 | -33.06 | PASS |
| A3 | 2 | 6e-09 | positive | 12 | raw | 0.6667 | 0.6667 | 0 | 8 | -17.06 | WARN |
| A6_odd | 1 | 3e-09 | negative | 50 | raw | 1 | 1 | 1 | -8 | -33.06 | PASS |
| A6_even | 2 | 3e-09 | positive | 50 | raw | 1 | 1 | 0 | 8 | -17.06 | PASS |
...
| --- | --- | --- | --- | --- | --- | --- |
| full | odd | 45 | -8 | -33.06 | 1 | PASS |
| full | even | 45 | 8 | -17.06 | 1 | PASS |
| minimal | odd | 5 | -8 | -33.06 | 1 | PASS |
| minimal | even | 5 | 8 | -17.06 | 1 | PASS |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0.4494 | nan | 0.4494 | 9.834e-08 | 2.188e-07 | FAIL | 0.8014 | WARN | 0 | FAIL | WARN | 0.5726 | FAIL | 0 | PASS | PASS | response | FAIL | WARN |
...
| --- | --- | --- | --- | --- | --- | --- |
| FAIL | PASS | FAIL | WARN | 8 | 8 | 138.1 |

| stage | status | n_rows | design_rank | design_cols | condition_number |
| --- | --- | --- | --- | --- | --- |
| stage1_EL_identifying | WARN | 111 | 8 | 8 | 138.1 |
| stage2_effects_after_EL | PASS | 175 | 5 | 5 | 16.29 |
...
| LOS1_q1 | 17 |  | none | PASS |
| LOS1_q2 | 23 |  | none | PASS |
| LOS1_q3 | 23 |  | none | PASS |

- D3 per-scenario summary (B1/B2/B3)

| scenario_id | status | n_rows | q1_db | q2_db | min_strata_all_n | min_strata_viable_n | qna_total |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B1 | FAIL | 25 | 2.495 | 4.195 | 0 | 1 | 0 |
| B2 | PASS | 25 | 2.499 | 4.19 | 0 | 3 | 0 |
| B3 | FAIL | 25 | 1.555 | 4.195 | 0 | 1 | 0 |
...
- C0 coupling-floor sanity: status=PASS, C0 floor=25.063 dB, nominal=35.000 dB, delta=-9.937 dB

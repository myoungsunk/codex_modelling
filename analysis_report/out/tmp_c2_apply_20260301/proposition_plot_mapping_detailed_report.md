...
| G1-3 | G1 | A2 | rho_early + incidence | [G1-3__A2_rho_vs_incidence.png](figures/G1-3__A2_rho_vs_incidence.png) | [G1-3__data.csv](tables/plot_data/G1-3__data.csv) | odd supports rho increase | PASS | READY |
...
| G2-2 | G2 | A3 | target-window summary | [G2-2__A3_xpd_target_ex_summary.png](figures/G2-2__A3_xpd_target_ex_summary.png) | [G2-2__data.csv](tables/plot_data/G2-2__data.csv) | co-dominant tendency | PASS | READY |
...
| R1-1 | R1 | B1/B2/B3 | x,y,XPD_early_ex | [R1-1__B123_heatmap_xpd_early_ex.png](figures/R1-1__B123_heatmap_xpd_early_ex.png) | [R1-1__data.csv](tables/plot_data/R1-1__data.csv) | spatial pattern | PASS | READY |
| R1-2 | R1 | B1/B2/B3 | x,y,rho_early | [R1-2__B123_heatmap_rho_early.png](figures/R1-2__B123_heatmap_rho_early.png) | [R1-2__data.csv](tables/plot_data/R1-2__data.csv) | cross contamination map | PASS | READY |
| R1-3 | R1 | B1/B2/B3 | x,y,L_pol | [R1-3__B123_heatmap_lpol.png](figures/R1-3__B123_heatmap_lpol.png) | [R1-3__data.csv](tables/plot_data/R1-3__data.csv) | early-late structure map | PASS | READY |
...
| R2-2 | R2 | B pooled | rho_early,DS | [R2-2__rho_early_vs_ds_B123.png](figures/R2-2__rho_early_vs_ds_B123.png) | [R2-2__data.csv](tables/plot_data/R2-2__data.csv) | contamination relation | PASS | READY |
| R2-3 | R2 | B pooled | XPD,DS,L_pol | [R2-3__quadrant_useful_vs_risky.png](figures/R2-3__quadrant_useful_vs_risky.png) | [R2-3__data.csv](tables/plot_data/R2-3__data.csv) | useful vs risky regions | PASS | READY |

# Proposition Mapping Report (tmp_c2_apply_20260301)
...
| G1 | A2 odd + LOS 차단 | co/cross PDP, XPD_early_ex, rho_early | PDP overlay + tap-wise XPD + 분포 | odd에서 early cross 우세 | PASS | READY |
| G2 | A3 even + LOS 차단 | co/cross PDP, XPD_early_ex, rho_early | A2 대비 CDF/box | A3가 A2 대비 반대방향 | PASS | READY |
...
| L2 | A4 material / A5 stress | material/stress label + XPD_ex | material/stress CDF + effect size | 재질/스트레스에 따라 평균/분산 이동 | PASS | READY |
| L3 | 통제+room + EL proxy | EL, XPD_ex | scatter + Spearman | EL 증가에 따라 XPD/XPR 감소 단조 | PARTIAL | READY |
| R1 | room grid LOS/NLOS | Z 맵(XPD_ex, rho, L_pol, DS) | heatmap + LOS/NLOS CDF | 공간 분포 + LOS/NLOS 차이 | PASS | READY |
| R2 | room grid + 지표 연결 | Z와 DS/early집중도 | DS vs XPD_ex, DS vs rho | 유효조건 영역 분리 | PASS | READY |
...
### G1
- Found:
  - [figures/A2A3C0__ALL__xpd_early_ex_cdf.png](figures/A2A3C0__ALL__xpd_early_ex_cdf.png)
...
### G2
- Found:
  - [figures/A2A3__ALL__xpd_early_ex_box.png](figures/A2A3__ALL__xpd_early_ex_box.png)
  - [figures/A2A3__ALL__xpd_early_ex_cdf.png](figures/A2A3__ALL__xpd_early_ex_cdf.png)
...
- Notes: median_span=11.439 dB, delta_floor=0.611 dB, iqr_overlap=True
...
### L2
- Found:
  - [figures/L2__A4_material_xpd_early_ex_cdf.png](figures/L2__A4_material_xpd_early_ex_cdf.png)

...
- git_commit: 54da8680762149cd823af64104635b5effa8280c
- git_dirty: True
- release_mode: False
- cmdline: /Users/kimmyoungsun/Documents/codex/scenarios/runner.py --basis circular --xpd-matrix-source J --physics-validation-mode --model-compare --output outputs/rt_dataset_phasecheck.h5 --plots-dir outputs/plots_phasecheck --report outputs/report_phasecheck.md --nf 256
- seed: {'model_seed': 0}
- WARNING: git_dirty=True (provenance risk for paper/release artifacts).
- xpd_matrix_source: J
...
- delay_ambiguity_period_ns: 63.750
...
- f2_pdp_peak_tau_rt_ns: 25.86730957031275
- f2_pdp_peak_tau_synth_ns: 25.244750976562738
...
- f3_xpd_ks2_D: 0.03743589743589744
- f3_xpd_ks2_D_full: 0.6841359773371105
- f3_xpd_ks2_D_global_cont: 0.03743589743589744
...
- f3_xpd_ks2_p: 0.9991198582498246
- f3_xpd_ks2_p_full: 7.709556857279447e-158
- f3_xpd_ks2_p_global_cont: 0.9991198582498246
...
- f3_xpd_mu_delta_abs_db: 0.02980526923354246
- f3_xpd_mu_rt_db: -0.05701814373307444
- f3_xpd_mu_synth_db: -0.027212874499531983
...
- f5_subband_mu_rmse_db: 0.029805269233625892
...
- f5_subband_sigma_rmse_db: 0.02474628615488995
- f5_subband_sigma_rmse_full_db: 7.784549398607
- f6_common_phase_removed: True
- f6_per_ray_sampling: True
- f6_phase_offdiag_amp_ratio_min: 0.001
- f6_phase_offdiag_rt_debug: {'amp_ratio_min': 0.001, 'n_total_candidates': 1412, 'n_after_amp_gate': 428, 'n_rejected_amp_gate': 984, 'amp_ratio_min_observed': 0.0, 'amp_ratio_median': 0.0, 'amp_ratio_p95': 0.7003481383306862, 'unique_phase_bin_count': 28, 'phase_top_bins': [{'bin_start_rad': 2.879793265790643, 'bin_end_rad': 3.141592653589793, 'count': 187}, {'bin_start_rad': 0.0, 'bin_end_rad': 0.26179938779914913, 'count': 187}, {'bin_start_rad': -2.356194490192345, 'bin_end_rad': -2.0943951023931957, 'count': 7}]}
- f6_phase_offdiag_synth_debug: {'amp_ratio_min': 0.001, 'n_total_candidates': 1412, 'n_after_amp_gate': 300, 'n_rejected_amp_gate': 1112, 'amp_ratio_min_observed': 7.071067811861935e-07, 'amp_ratio_median': 7.07106781186194e-07, 'amp_ratio_p95': 0.6883834114651948, 'unique_phase_bin_count': 36, 'phase_top_bins': [{'bin_start_rad': 2.094395102393195, 'bin_end_rad': 2.356194490192345, 'count': 18}, {'bin_start_rad': 0.26179938779914913, 'bin_end_rad': 0.5235987755982987, 'count': 18}, {'bin_start_rad': 0.5235987755982987, 'bin_end_rad': 0.7853981633974478, 'count': 15}]}
- f6_phase_sampling_method: iid
- f6_phase_test_basis: J
- f6_phase_uniformity_V_rt: 0.4528784370695408
- f6_phase_uniformity_V_synth: 0.07087307184448052
- f6_phase_uniformity_p: 0.444
- f6_phase_uniformity_p_rt: 0.0
- f6_phase_uniformity_p_synth: 0.444
- per_ray_sampling: True
- phase_offdiag_amp_ratio_min: 0.001
- phase_offdiag_rt_debug: {'amp_ratio_min': 0.001, 'n_total_candidates': 1412, 'n_after_amp_gate': 428, 'n_rejected_amp_gate': 984, 'amp_ratio_min_observed': 0.0, 'amp_ratio_median': 0.0, 'amp_ratio_p95': 0.7003481383306862, 'unique_phase_bin_count': 28, 'phase_top_bins': [{'bin_start_rad': 2.879793265790643, 'bin_end_rad': 3.141592653589793, 'count': 187}, {'bin_start_rad': 0.0, 'bin_end_rad': 0.26179938779914913, 'count': 187}, {'bin_start_rad': -2.356194490192345, 'bin_end_rad': -2.0943951023931957, 'count': 7}]}
- phase_offdiag_synth_debug: {'amp_ratio_min': 0.001, 'n_total_candidates': 1412, 'n_after_amp_gate': 300, 'n_rejected_amp_gate': 1112, 'amp_ratio_min_observed': 7.071067811861935e-07, 'amp_ratio_median': 7.07106781186194e-07, 'amp_ratio_p95': 0.6883834114651948, 'unique_phase_bin_count': 36, 'phase_top_bins': [{'bin_start_rad': 2.094395102393195, 'bin_end_rad': 2.356194490192345, 'count': 18}, {'bin_start_rad': 0.26179938779914913, 'bin_end_rad': 0.5235987755982987, 'count': 18}, {'bin_start_rad': 0.5235987755982987, 'bin_end_rad': 0.7853981633974478, 'count': 15}]}
- phase_test_basis: circular
- phase_uniformity_V_rt: 0.4528784370695408
- phase_uniformity_V_synth: 0.07087307184448052
- phase_uniformity_p: 0.444
- phase_uniformity_p_rt: 0.0
- phase_uniformity_p_synth: 0.444
- phase_uniformity_rt_status: INFO_DETERMINISTIC
- phase_uniformity_synth_hint: none
- phase_uniformity_synth_status: PASS
- rt_num_paths: 706
...
- subband_mu_rmse: 0.029805269233625892
- subband_mu_rmse_full: 9.34192286324555
- subband_mu_rt_cont_db: [-0.05701814373307546, -0.05701814373307546, -0.05701814373307546, -0.05701814373307546]
...
- subband_mu_span_synth_cont: 5.561992065875043e-08
- subband_mu_synth_cont_db: [-0.02721287293043627, -0.027212845017690876, -0.027212900637611535, -0.027212879412086083]
- subband_mu_synth_db: [93.4767149865093, 93.47671499267699, 93.47671498038702, 93.4767149850771]
- subband_sigma_rmse: 0.02474628615488995
...
- subband_sigma_synth_cont_db: [26.233805544817724, 26.23380549929225, 26.233805532229685, 26.233805532711123]
...
- synthetic_parity_xpd: {'even': {'mu': 90.8566097216281, 'sigma': 53.397532548870515, 'n': 614}, 'odd': {'mu': 110.9630696864253, 'sigma': 29.13418164117512, 'n': 92}}
...
- f3_xpd_ks2_p: 0.9991
- f3_xpd_ks2_p_global_cont: 0.9991
...
- f5_status: PASS_WITH_CENSORING
- phase_test_config: basis=circular, common_phase_removed=True, per_ray_sampling=True, sampling_method=iid, offdiag_amp_ratio_min=1.00e-03
- phase_test_rt_status: INFO_DETERMINISTIC
- phase_test_synth_status: PASS
- phase_offdiag_rt_samples: 428/1412
- phase_offdiag_synth_samples: 300/1412
...
- n_cases: 121
- delta_tau_median_s: 9.945e-12
- delta_tau_max_s: 1.538e-11
...
- outlier_csv: outputs/report_phasecheck_tap_path_outliers.csv
- repro_bundle_json: outputs/report_phasecheck_tap_path_repro_bundle.json
- repro_bundle_cases: 0
- per-case (scenario/case): Δtau_s, ΔXPD_dB, overlap_count, reason, wrap, n_paths
- C0/0: delta_tau_s=1.486e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- C0/1: delta_tau_s=1.413e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- C0/2: delta_tau_s=1.344e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A1/0: delta_tau_s=5.350e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A1/1: delta_tau_s=9.703e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A1/2: delta_tau_s=1.430e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/0: delta_tau_s=6.366e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/1: delta_tau_s=4.822e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/2: delta_tau_s=1.345e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/3: delta_tau_s=5.709e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/4: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/5: delta_tau_s=1.432e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/6: delta_tau_s=4.764e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/7: delta_tau_s=1.888e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2/8: delta_tau_s=1.963e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/0: delta_tau_s=2.016e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/1: delta_tau_s=9.635e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/2: delta_tau_s=1.465e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/3: delta_tau_s=9.303e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/4: delta_tau_s=nan, delta_xpd_db=nan, overlap_count=0, reason=EMPTY, wrap=False, n_paths=0
- A2R/5: delta_tau_s=1.059e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/6: delta_tau_s=4.240e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/7: delta_tau_s=6.583e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/8: delta_tau_s=1.019e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/9: delta_tau_s=9.685e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/10: delta_tau_s=1.313e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/11: delta_tau_s=1.218e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/12: delta_tau_s=5.309e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/13: delta_tau_s=nan, delta_xpd_db=nan, overlap_count=0, reason=EMPTY, wrap=False, n_paths=0
- A2R/14: delta_tau_s=3.020e-13, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A2R/15: delta_tau_s=7.615e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3/0: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3/1: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3/2: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3/3: delta_tau_s=2.333e-13, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3R/0: delta_tau_s=2.917e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3R/1: delta_tau_s=4.061e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3R/2: delta_tau_s=4.615e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A3R/3: delta_tau_s=7.283e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/0: delta_tau_s=4.822e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/1: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/2: delta_tau_s=1.888e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/3: delta_tau_s=4.822e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/4: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/5: delta_tau_s=1.888e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/6: delta_tau_s=4.822e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/7: delta_tau_s=8.241e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A4/8: delta_tau_s=1.888e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/0: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/1: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/2: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/3: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/4: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/5: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/6: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/7: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/8: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/9: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/10: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/11: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/12: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/13: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/14: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/15: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/16: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/17: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/18: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/19: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/20: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/21: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/22: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/23: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/24: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/25: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/26: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/27: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/28: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A5/29: delta_tau_s=1.134e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/0: delta_tau_s=9.513e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/1: delta_tau_s=5.350e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/2: delta_tau_s=9.513e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/3: delta_tau_s=2.879e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/4: delta_tau_s=7.027e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/5: delta_tau_s=2.879e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/6: delta_tau_s=1.357e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/7: delta_tau_s=1.344e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/8: delta_tau_s=1.357e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=1
- A6/9: delta_tau_s=1.221e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/9); tap/path direct comparison limited.
- A6/10: delta_tau_s=1.430e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/10); tap/path direct comparison limited.
- A6/11: delta_tau_s=1.221e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/11); tap/path direct comparison limited.
- A6/12: delta_tau_s=1.278e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/12); tap/path direct comparison limited.
- A6/13: delta_tau_s=1.070e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/13); tap/path direct comparison limited.
- A6/14: delta_tau_s=1.278e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/14); tap/path direct comparison limited.
- A6/15: delta_tau_s=7.866e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/15); tap/path direct comparison limited.
- A6/16: delta_tau_s=9.945e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/16); tap/path direct comparison limited.
- A6/17: delta_tau_s=7.866e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=2
-   NOTE: overlap-labeled case (A6/17); tap/path direct comparison limited.
- B0/0: delta_tau_s=8.427e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/1: delta_tau_s=1.089e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/1); tap/path direct comparison limited.
- B0/2: delta_tau_s=3.391e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=21
-   NOTE: overlap-labeled case (B0/2); tap/path direct comparison limited.
- B0/3: delta_tau_s=1.089e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/3); tap/path direct comparison limited.
- B0/4: delta_tau_s=8.427e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/5: delta_tau_s=6.865e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/6: delta_tau_s=1.349e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/7: delta_tau_s=3.013e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=21
-   NOTE: overlap-labeled case (B0/7); tap/path direct comparison limited.
- B0/8: delta_tau_s=1.349e-11, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/9: delta_tau_s=6.865e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=25
- B0/10: delta_tau_s=1.162e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/10); tap/path direct comparison limited.
- B0/11: delta_tau_s=1.530e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/11); tap/path direct comparison limited.
- B0/12: delta_tau_s=1.232e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=21
-   NOTE: overlap-labeled case (B0/12); tap/path direct comparison limited.
- B0/13: delta_tau_s=1.530e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/13); tap/path direct comparison limited.
- B0/14: delta_tau_s=1.162e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/14); tap/path direct comparison limited.
- B0/15: delta_tau_s=5.935e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/15); tap/path direct comparison limited.
- B0/16: delta_tau_s=9.305e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/16); tap/path direct comparison limited.
- B0/17: delta_tau_s=1.538e-11, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=21
-   NOTE: overlap-labeled case (B0/17); tap/path direct comparison limited.
- B0/18: delta_tau_s=9.305e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/18); tap/path direct comparison limited.
- B0/19: delta_tau_s=5.935e-12, delta_xpd_db=nan, overlap_count=2, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/19); tap/path direct comparison limited.
- B0/20: delta_tau_s=2.340e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=24
- B0/21: delta_tau_s=8.151e-12, delta_xpd_db=nan, overlap_count=4, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/21); tap/path direct comparison limited.
- B0/22: delta_tau_s=7.039e-12, delta_xpd_db=nan, overlap_count=4, reason=OVERLAP, wrap=False, n_paths=21
-   NOTE: overlap-labeled case (B0/22); tap/path direct comparison limited.
- B0/23: delta_tau_s=8.151e-12, delta_xpd_db=nan, overlap_count=4, reason=OVERLAP, wrap=False, n_paths=25
-   NOTE: overlap-labeled case (B0/23); tap/path direct comparison limited.
- B0/24: delta_tau_s=2.340e-12, delta_xpd_db=0.000, overlap_count=1, reason=NONE, wrap=False, n_paths=24
...
- hard_gates: {'A_git_clean_check': True, 'B_geometry_invariants': True, 'C10_full_coverage': True, 'D_wrap_zero': False, 'F3_model_compare': True}
- hard_fail: ['D_wrap_zero']
- hard_fail_count: 1
- rich_mode: False
...
- wrap_detected_cases_total: 4
- HARD_GATE_SUMMARY_JSON: {"geometry_stats": {"bad_aoa_shape": 0, "bad_aod_shape": 0, "bad_bounce_count": 0, "bad_incidence_angles_len": 0, "bad_interactions_len": 0, "bad_matrix_nan": 0, "bad_matrix_shape": 0, "bad_segment_basis_len": 0, "bad_surface_ids_len": 0, "bad_tau": 0, "pass": true, "total_paths": 706, "violations_total": 0}, "hard_fail": ["D_wrap_zero"], "hard_fail_count": 1, "hard_gates": {"A_git_clean_check": true, "B_geometry_invariants": true, "C10_full_coverage": true, "D_wrap_zero": false, "F3_model_compare": true}, "release_mode": false, "rich_avg_paths_per_case": {"A1": 1.0, "A2": 1.0, "A2R": 0.875, "A3": 1.0, "A3R": 1.0, "A4": 1.0, "A5": 1.0, "A6": 1.5, "B0": 24.12, "C0": 1.0}, "rich_mode": false, "rich_multipath_gate": true, "wrap_detected_cases_total": 4}

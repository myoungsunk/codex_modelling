...
- delay_ambiguity_period_ns: 5.750
...
- pdp_sum_consistency_max_abs: 0.000e+00
- WARNING: CIR delay ambiguity/wrap detected (tau > 1/df aliasing likely); use denser frequency grid, delay unwrapping, or path-domain validation.
- parity XPD stats (exact_bounce=1): {'odd': {'mu': 21.042040000598416, 'sigma': 14.484561962940276, 'n': 12}}
...
- pdp_sum_consistency_max_abs: 0.000e+00
- WARNING: CIR delay ambiguity/wrap detected (tau > 1/df aliasing likely); use denser frequency grid, delay unwrapping, or path-domain validation.
- parity XPD stats (exact_bounce=2): {'even': {'mu': 9.613998443828747, 'sigma': 3.301856413234934, 'n': 4}}
...
- strongest path: tau=4.895e-08s, power=5.000e-01
- LOS exists: True
...
- f2_pdp_peak_tau_rt_ns: 2.8441162109374982
- f2_pdp_peak_tau_synth_ns: 2.936767578124998
- f3_xpd_mu_rt_db: 84.41587636503128
- f3_xpd_mu_synth_db: 3.814241365967849
- f4_parity_direction_match: True
- f4_rt_even_mu_db: 74.17529418348373
- f4_rt_odd_mu_db: 112.32010823538575
- f4_synth_even_mu_db: -25.770752511883362
- f4_synth_odd_mu_db: 62.29620600823186
- model_params_json: outputs/rt_minpass_check_model_params.json
- synthetic_compare_json: outputs/rt_minpass_check_synthetic_compare.json

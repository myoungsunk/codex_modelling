...
def _make_cfg(
    ...
    return ExperimentConfig(
        ...
        material_xpol_coupling_db=material_xpol_coupling_db,
    )
...
def _evaluate_screening(
    ...
    for spec in scenario_specs:
        ...
        rx_x, rx_y, valid_mask = scenario_grid(spec, screening_grid_step, material_xpol_coupling_db=material_xpol_coupling_db)
        cfg = _make_cfg(
            spec,
            fc,
            bw,
...
def _evaluate_scene_grid(
    ...
    layout = build_scenario_layout(spec, material_xpol_coupling_db=material_xpol_coupling_db)
    rx_x, rx_y, valid_mask = scenario_grid(spec, grid_step, material_xpol_coupling_db=material_xpol_coupling_db)
    cfg = _make_cfg(
        spec,
        fc,
        bw,

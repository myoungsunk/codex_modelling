...
class RealisticCompareTests(unittest.TestCase):
    ...
    def test_standard_file_helper_uses_fixed_filenames(self) -> None:
        ...
        self.assertEqual(families["tx_cp"].antenna_mode, "realistic_patch_cp")
        self.assertEqual(families["tx_cp"].basis, "circular")
        self.assertGreaterEqual(families["tx_cp"].cross_pol_leakage_db, 0.0)
        self.assertGreaterEqual(families["tx_cp"].tx_pattern_cos_exp, 0.0)
